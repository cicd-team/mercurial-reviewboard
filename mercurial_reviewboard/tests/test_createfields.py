...
def set_up_two_revs():
    ...
    c = repo[1]
    parentc = repo[b'0000000000000000000000000000000000000000']
...
def test_target_people():
    ...
    opts['target_people'] = b'john, jane'
...
def test_branch_description():
    ...
    expected = 'review of branch: b\'the_branch\'\n\nchangesets:\n\t4:173fa0623445 "4"\n\t3:0c15fa2e6ba5 "3"\n'
